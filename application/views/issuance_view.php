...
<div class="container-fluid"">
    <div data-widget-group="group1">
        <div class="row">
            <div class="col-md-12">
                    <div id="div_requisitions">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Requisitions for Review</b>
                            </div>
                    ...
                    <div id="div_issuance_list">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Issuance</b>
                            </div>
                            <div class="panel-body table-responsive">
                                <table id="tbl_issuances" class="table-striped custom-design" cellspacing="0" width="100%">
                                    <thead class="">
                                    <tr>
                                        <th></th>
                                        <th>Slip #</th>
...
$(document).ready(function(){
    var dt; var _txnMode;  var dtRequisitions;
    var _selectedID; 
    var _selectRowObj; 
    var _cboDepartments; 
    var dt_si; 
    ...
    var initializeControls=function(){
        dtRequisitions=$('#tbl_requisitions').DataTable({
            "bLengthChange":false,
            "pageLength":15,
            "ajax" : "Requisition/transaction/open",
            "columns": [
                {
                    "targets": [0],
    ...
    var showList=function(b){
        if(b){
            $('#div_issuance_list').show();
            $('#div_user_fields').hide();
        }else{
            $('#div_issuance_list').hide();
