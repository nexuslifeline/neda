...
$(document).ready(function(){
    ...
    function format ( d ) {
        ...
        '<tbody>' +
        '<tr>' +
        '<td width="20%">Item Code : </td><td width="50%"><b>'+ d.product_code+'</b></td>' +
        '</tr>' +
        '<tr>' +
        '<td>Item Name : </td><td>'+ d.product_desc+'</td>' +
        '</tr>' +
        '<tr>' +
        '<td>Item Description : </td><td>'+ d.product_desc1+'</td>' +
        '</tr>' +
        '<tr>' +
        '<td>Supplier : </td><td>'+ d.supplier_name+'</td>' +
        '</tr>' +
        '<tr>' +
        '<td>Item Type : </td><td>'+ d.product_type+'</td>' +
        '</tr>' +
        '<tr>' +
        ...
        <div class="static-content-wrapper white-bg">
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin:0%;">
                        ...
                        <li><a href="products" id="filter">Items</a></li>
                    </ol>
                                    ...
                                    <div id="div_product_list">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Items</b>
                                            </div>
                                            <div class="panel-body table-responsive">
                                                <button class="btn btn-primary" id="btn_new" style="float: left; text-transform: capitalize;font-family: Tahoma, Georgia, Serif;margin-bottom: 0px !important;" data-toggle="modal" data-target="" data-placement="left" title="Create New Item" ><i class="fa fa-plus"></i> Create New Item</button>
                                                <table id="tbl_products" class="table-striped custom-design" cellspacing="0" width="100%">
                                                    <thead class="">
                                                    <tr>    
                                                        <th></th>
                                                        <th>Stock #</th>
            ...
            <div id="modal_product_type" class="modal fade" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title""><span id="modal_mode"> </span>New Item Type</h4>
                        </div>
                        <div class="modal-body">
                            <form id="frm_product_type">
                                <div class="form-group">
                                    <label class="boldlabel">* Item Type :</label>
                                    <div class="input-group">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-cube"></i>
                                                </span>
                                        <input type="text" name="product_type" id="product_type" class="form-control" placeholder="Item Type" data-error-msg="Item Type is required!" required>
                                    </div>
                                </div>
            ...
            <div id="modal_create_product" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
                <div class="modal-dialog" style="width: 60%;">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#2ecc71;">
                            <button type="button" class="close"   data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:#ecf0f1;"><span id="modal_mode"> </span>Item Information</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group" style="margin-bottom:0px;">
                                                ...
                                                <textarea name="product_desc" id="product_desc"class="form-control" data-error-msg="Item Description is required." required></textarea>
                                        </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#27ae60;">
                            ...
                            <h4 class="modal-title" style="color:white;"><span id="modal_mode"> View Item List </h4>
                        </div>
