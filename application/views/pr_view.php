                                    ...
                                    <div id="div_user_list">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body table-responsive">
                                                ...
                                                <table id="tbl_purchase_request" class="table-striped custom-design" cellspacing="0" width="100%">
                                                    <thead class="">
                                                    <tr>
                                                        <th>PR#</th>
                                                        <th>Request Date</th>
                                    ...
                                    <div id="div_user_fields" style="display: none;">
                                        <div class="panel panel-default" style="border: 4px solid #2980b9;border-radius: 8px;">
                                            ...
                                            <div class="panel-body"  style="padding-bottom: 0%;padding-top: 0%;">
                                                ...
                                                <div class="row">
                                                <form id="frm_Purchase_request" role="form" class="form-horizontal">
                                                    <h4 style="margin: 15px;"><b>PR # : <span id="span_pr_no">PO-XXXX</span></b></h4>
                                                    <div style="border: 1px solid #a0a4a5;padding: 1%;border-radius: 5px;margin: 15px;">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="pr_no" class="form-control" placeholder="PO-YYYYMMDD-XXX" readonly>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                Purpose : <br />
                                                                <textarea name="reason" class="form-control" placeholder="Purpose"></textarea>
                                                            </div>
                                                        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header " style="padding: 5px !important;">
                        <h2 style="color:white; padding-left: 10px;">Purchase Request</h2>
                    </div>
                    <div class="modal-body">
...
<script>
    ...
    $(document).ready(function(){
        ...
        var initializeControls=function(){
            ...
            dt=$('#tbl_purchase_request').DataTable({
                "dom": '<"toolbar">frtip',
                "bLengthChange":false,
                "pageLength":15,
                "ajax" : "Purchase_request/transaction/list",
                "columns": [
                    { targets:[0],data: "pr_no" },
                    { targets:[1],data: "date_posted" },
                    { targets:[2],data: "request_by" },
            ...
            var createToolBarButton=function(){
                var _btnNew='<button class="btn btn-primary"  id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="New Purcahase Order" >'+
                    '<i class="fa fa-plus"></i> New Purchase Request</button>';
            ...
            /*var products = new Bloodhound({
             ...
             remote: {
             cache: false,
             url: 'Purchase_request/transaction/product-lookup/',
            ...
            _objTypeHead.typeahead(null, {
                ...
                $('#tbl_items > tbody').append(newRowItem({
                    ...
                    pr_line_total_discount : "0.00",
                    tax_exempt : false,
                    pr_tax_rate : tax_rate,
                    pr_price : purchase_cost,
                    pr_discount : "0.00",
                    tax_type_id : null,
                    pr_line_total : total,
                    pr_non_tax_amount: net_vat,
                    pr_tax_amount:vat_input
                }));
        ...
        var bindEventHandlers=(function(){
            ...
            $('#tbl_purchase_request tbody').on( 'click', 'tr td.details-control', function () {
                ...
                if ( row.child.isShown() ) {
                    ...
                    window.open("Templates/layout/po/"+d.pr_info_id+"?type=preview","dsv", "location=0,status=0,scrollbars=0,width=700,height=400");
                    //dualDisplayHandle.location.href = "Templates/layout/po/"+d.pr_info_id+"?type=preview";
                    /*$.ajax({
                     "dataType":"html",
                     "type":"POST",
                     "url":"Templates/layout/po/"+ d.pr_info_id,
                     // "beforeSend" : function(){
            ...
            $('#tbl_purchase_request tbody').on('click','#btn_email',function(){
                ...
                $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":"Email/send/po/"+ d.pr_info_id,
            ...
            $('#btn_new').click(function(){
                _txnMode="new";
                $('#span_pr_no').html("PR-XXXX");

                //$('.toggle-fullscreen').click();
                clearFields($('#frm_Purchase_request'));
          ...
          /*  $('#btn_create_new_supplier').click(function(){
            ...
            $('#tbl_purchase_request tbody').on('click','button[name="edit_info"]',function(){
                ///alert("ddd");
                _txnMode="edit";
                _selectRowObj=$(this).closest('tr');
                ...
                $('#span_pr_no').html(data.pr_no);

                if(getFloat(data.order_status_id)>1){
                    showNotification({"title":"Error!","stat":"error","msg":"Sorry, you cannot edit Purchase Request that is already been received."});
                    return;
                }
            ...
            /*    $('#cbo_suppliers').select2('val',data.supplier_id);*/
                ...
                $.ajax({
                    url : 'Purchase_request/transaction/items/'+data.pr_info_id,
                    type : "GET",
                    cache : false,
                    dataType : 'json',
                    processData : false,
                    ...
                    success : function(response) {
                        ...
                        $.each(rows,function(i,value){
                            ...
                            $('#tbl_items > tbody').append(newRowItem({
                                ...
                                pr_line_total_discount : value.pr_line_total_discount,
                                tax_exempt : false,
                                pr_tax_rate : value.pr_tax_rate,
                                pr_price : value.pr_price,
                                pr_discount : value.pr_discount,
                                tax_type_id : null,
                                pr_line_total : value.pr_line_total,
                                pr_non_tax_amount: value.non_tax_amount,
                                pr_tax_amount:value.tax_amount
                            }));
                        });
            ...
            $('#tbl_purchase_request tbody').on('click','button[name="remove_info"]',function(){
                _selectRowObj=$(this).closest('tr');
                var data=dt.row(_selectRowObj).data();
                _selectedID=data.pr_info_id;
            ...
            $('#btn_yes').click(function(){
                ...
                //showNotification({title:"Error!",stat:"error",msg:"Sorry, you cannot delete Purchase Request that is already been recorded on purchase invoice."});
                //}else{
            ...
            $('#btn_save').click(function(){
                ...
                if(validateRequiredFields($('#frm_Purchase_request'))){
                    if(_txnMode=="new"){
     ...
     /*   var createSupplier=function() {
        ...
        var createPurchaseOrder=function(){
            var _data=$('#frm_Purchase_request,#frm_items').serializeArray();
            ...
            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Purchase_request/transaction/create",
                "data":_data,
        ...
        var updatePurchaseOrder=function(){
            ...
            _data.push({name : "summary_tax_amount", value : tbl_summary.find(oTableDetails.tax_amount).text()});
            _data.push({name : "summary_after_tax", value : tbl_summary.find(oTableDetails.after_tax).text()});
            _data.push({name : "pr_info_id" ,value : _selectedID});
            _data.push({name : "remarks", value : $('textarea[name="remarks"]').val() });

            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Purchase_request/transaction/update",
                "data":_data,
                "beforeSend": showSpinningProgress($('#btn_save'))
            });
        };
        ...
        var removePurchaseOrder=function(){
            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Purchase_request/transaction/delete",
