...
<div id="div_user_list">
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="tbl_purchases" class="table-striped custom-design" cellspacing="0" width="100%">
                <thead class="">
                <tr>
                    <th></th>
                    <th>PO#</th>
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_purchases tbody').on( 'click', 'tr td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                window.open("Templates/layout/po/"+d.purchase_order_id+"?type=preview","dsv", "location=0,status=0,scrollbars=0,width=700,height=400");
                //dualDisplayHandle.location.href = "Templates/layout/po/"+d.purchase_order_id+"?type=preview";
                /*$.ajax({
                    "dataType":"html",
                    "type":"POST",
