...
<div id="div_delivery_list">
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="tbl_delivery_invoice" class="table-striped custom-design" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th></th>
                    <th>Invoice #</th>
...
<div id="modal_po_list" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
    <div class="modal-dialog" style="width: 80%;">
        <div class="modal-content"><!---content--->
            ...
            <div class="modal-body">
                <table id="tbl_po_list" class="table-striped custom-design" cellspacing="0" width="100%">
                    <thead class="">
                    <tr>
                        <th></th>
                        <th>PO#</th>
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_delivery_invoice tbody').on( 'click', 'tr td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                window.open("Templates/layout/dr/"+ d.dr_invoice_id+"?type=preview","dsv", "location=0,status=0,scrollbars=0,width=700,height=400");
