            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    <ol class="breadcrumb" style="margin:0%;">
                        ...
                        <li><a href="Supplies_issued">Supplies and Material Issued Report</a></li>
                    </ol>
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" style="color: white;">Supplies and Material Issued Report</h4>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="input-group" style="z-index: 99999">
                                                        ...
                                                        <input type="text" name="date_start" id="dt_start_date" class="date-picker form-control" value="<?php echo date("m"); ?>/1/<?php echo date("Y"); ?>"  placeholder="Start Date" data-error-msg="Start date is required!" required>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_print').click(function(){
            //$(this).attr('href',"inventory/transaction/materials-issued?type=&type=preview&start="+$('#dt_start_date').val()+"&end="+$('#dt_end_date').val());
            window.open("inventory/transaction/materials-issued?type=&type=preview&start="+$('#dt_start_date').val()+"&end="+$('#dt_end_date').val(),"dsv", "location=0,status=0,scrollbars=0,width=950,height=590");
