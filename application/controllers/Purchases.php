            ...
            switch ($txn){
                ...
                case 'open':  //this returns PO that are already approved
                    ...
                    $response['data']= $m_purchases->get_list(
                        ...
                        'purchase_order.is_deleted=FALSE AND purchase_order.is_active=TRUE AND (purchase_order.order_status_id=1 OR purchase_order.order_status_id=3) AND purchase_order.approval_id=1',
